...
print("Starting generation of Buzz Tracker dataset...")
...
with open(output_path, 'w', newline='', encoding='utf-8') as csvfile:
    ...
    for i in range(NUM_ROWS):
        ...
        sentiment_score = round_float(random.uniform(-1.0, 1.0), 2)
        ...
        toxicity_score = round_float(random.uniform(0, 1), 3)
        ...
        engagement_rate = round_float(engagement / max(1, impressions), 4)
        
        # 6. Historical Tracking
        user_past_sentiment_avg = round_float(random.uniform(-1, 1), 2)
        user_engagement_growth = round_float(random.uniform(-0.5, 0.5), 3)
...
print("\nNote: Excel file (.xlsx) was not created as it requires additional libraries (pandas/openpyxl).")
print("You can open the CSV file in Excel directly.")
